...
//##
//## #Version with Thorson Dirichlet-Multinomial Asymptotic
//##--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>
DATA_SECTION
...
//-----------------------------------------------------------------------------------
//Likelihood contribution: Dirichlet-multinomial, Asymptotic paramaterization
FUNCTION dvariable lk_dirichlet_multinomial(const dvar_vector& nsamp, const dvar_matrix& pred_comp, const dvar_matrix& obs_comp, const double& ncomp, const double& mbin, const dvariable& log_dir_par)
  ...
  dvariable theta=mfexp(log_dir_par);   //DMA param
  ...
  {
   //Full Likelihood
   LkvalTmp += -1*(gammln(nsamp(ii)+1)-sum(gammln(nsamp(ii)*obs_comp_norm(ii)+ones))+gammln(theta)-gammln(nsamp(ii)+theta)+sum(gammln(nsamp(ii)*obs_comp_norm(ii)+theta*pred_comp(ii))-gammln(theta*pred_comp(ii))));
  }
...
//-----------------------------------------------------------------------------------
//Individual Likelihood contribution: Dirichlet-multinomial, Asymptotic paramaterization
FUNCTION dvariable lk_dirichlet_multinomial_ind(const double& nsamp, const dvar_vector& pred_comp, const dvar_vector& obs_comp, const double& mbin, const dvariable& log_dir_par)
  ...
  for (int jj=1;jj<=mbin;jj++){
   ...
   //Full Likelihood
   LkvalTmp = -1.0*(gammln(nsamp+1)-sum(gammln(nsamp*obs_comp_norm+1))+gammln(theta)-gammln(nsamp+theta)+sum(gammln(nsamp*obs_comp_norm+theta*pred_comp)-gammln(theta*pred_comp)));
